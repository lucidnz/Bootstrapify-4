...
},{"./../../bower_components/shopify-cartjs/dist/cart.js":2,"./bsify.js":13,"./bsify.lookbook_gallery.js":15,"./phd.js":30}],2:[function(require,module,exports){
...
var SixPackBuilder=require("./phd.cart.sixpack.js"),MultiStepBuilder=require("./phd.cart.multistep.js"),StandardCart=require("./phd.cart.standard.js"),PhdCart=function(){new StandardCart,new SixPackBuilder,new MultiStepBuilder};module.exports=PhdCart;


},{"./phd.cart.multistep.js":23,"./phd.cart.sixpack.js":28,"./phd.cart.standard.js":29}],23:[function(require,module,exports){
var MultiStepBuilder=function(t){this.standard_cart=t};module.exports=MultiStepBuilder;


},{}],24:[function(require,module,exports){
var Eventer=require("./_eventer.js"),ItemsHolder=require("./phd.cart.sixpack.holder_items.js"),ItemsDisplay=require("./phd.cart.sixpack.holder_display.js"),SixPackHolder=function(e){this.$ele=e,new Eventer(this);var t=this.$ele.data("phd-holding-limit-multiple")||6,i=this.$ele.find("[data-phd-holding-items]");this.items=new ItemsHolder(t),this.items_display=new ItemsDisplay(i,t,this.items),this._add_event_listeners()};SixPackHolder.prototype.add_to_holding=function(e){return this.items.add_item(e),this.items.item_count(e.id)},SixPackHolder.prototype.remove_from_holding=function(e){return this.items.remove_item(e),this.items.item_count(e)},SixPackHolder.prototype.update_item_in_holding=function(e,t){return this.items.update_item(e,t),this.items.item_count(e.id)},SixPackHolder.prototype._add_event_listeners=function(){},module.exports=SixPackHolder;


},{"./_eventer.js":9,"./phd.cart.sixpack.holder_display.js":25,"./phd.cart.sixpack.holder_items.js":26}],25:[function(require,module,exports){
var SixPackHolderItemsDisplay=function(t,i,e){this.$ele=t,this.items=e,this.limit_multiple=i,this._add_event_listeners(),this._build_empty_display_items()};SixPackHolderItemsDisplay.prototype.update=function(){this._redraw_display_items(),this._update_display_items()},SixPackHolderItemsDisplay.prototype._add_event_listeners=function(){var t=this;t.items.on("ItemsUpdated",function(){t.update()})},SixPackHolderItemsDisplay.prototype._redraw_display_items=function(){this.$ele.html("");for(var t=this.items.total_count(),i=Math.floor(t/this.limit_multiple)+1,e=0;i>e;e++)this._build_empty_display_items()},SixPackHolderItemsDisplay.prototype._build_empty_display_items=function(){for(var t=0;t<this.limit_multiple;t++)this.$ele.append(this._empty_display_item_markup())},SixPackHolderItemsDisplay.prototype._empty_display_item_markup=function(){return'<div class="holding-item holding-item-disabled"><span class="text-muted">item</span></div>'},SixPackHolderItemsDisplay.prototype._update_display_items=function(){for(var t=this.items.total_count(),i=0;t>i;i++){var e=this.items.product_by_index(i);this.$ele.find(".holding-item").eq(i).removeClass("holding-item-disabled").html(e.title)}},module.exports=SixPackHolderItemsDisplay;


},{}],26:[function(require,module,exports){
var Eventer=require("./_eventer.js"),SixPackHolderItems=function(t){new Eventer(this),this.products=[],this.products_are_addable=!1,this.limit_multiple=t};SixPackHolderItems.prototype.add_item=function(t){this.products.push(t),this._update_is_addable_and_trigger("ItemAdded")},SixPackHolderItems.prototype.remove_item=function(t){for(var e=this.total_count()-1;e>-1;e--){var r=this._remove_product_from_stack(t,e);if(r)break}this._update_is_addable_and_trigger("ItemRemoved")},SixPackHolderItems.prototype.update_item=function(t,e){console.log("update_item",e);for(var r=0;r<this.products.length;r++)this._remove_product_from_stack(t.id,r);if(e>0)for(var o=0;e>o;o++)this.products.push(t);this._update_is_addable_and_trigger("ItemUpdated")},SixPackHolderItems.prototype.item_count=function(t){for(var e=0,r=0;r<this.products.length;r++)this.products[r].id===t&&e++;return e},SixPackHolderItems.prototype.total_count=function(){return this.products.length},SixPackHolderItems.prototype.product_by_index=function(t){return this.products[t]},SixPackHolderItems.prototype._remove_product_from_stack=function(t,e){var r=[];return this.products[e].id===t&&(r=this.products.splice(e,1)),r.length>0},SixPackHolderItems.prototype._update_is_addable_and_trigger=function(t){this.products_are_addable=this._is_addable(),this.trigger(t),this.trigger("ItemsUpdated")},SixPackHolderItems.prototype._is_addable=function(){var t=this.total_count(),e=t%this.limit_multiple;return t>0&&0===e},module.exports=SixPackHolderItems;


},{"./_eventer.js":9}],27:[function(require,module,exports){
var Eventer=require("./_eventer.js"),DataModel=require("./_data_model.js"),SixPackItem=function(t,e){this.$ele=t,this.id=e,new Eventer(this),new DataModel(this,{holding_count:"[data-phd-item-"+this.id+"-count]"}),this.variant_id=this.$ele.data("phd-variant-id"),this.product_title=this.$ele.data("phd-product-title"),this.product={id:this.variant_id,title:this.product_title},this._add_event_listeners()};SixPackItem.prototype._add_event_listeners=function(){var t=this;t.$ele.on("click","[data-phd-add-item]",function(e){e.preventDefault(),e.currentTarget.blur(),t._trigger_add_to()}),t.$ele.on("click","[data-phd-remove-item]",function(e){e.preventDefault(),e.currentTarget.blur(),t._trigger_remove_from()}),t.$ele.on("blur","[data-phd-edit-item]",function(e){var i=parseInt(e.currentTarget.value);t._trigger_update_holding(i)})},SixPackItem.prototype._trigger_add_to=function(){var t=[this.product];this.trigger("AddToHolding",t)},SixPackItem.prototype._trigger_remove_from=function(){var t=[this.variant_id];this.trigger("RemoveFromHolding",t)},SixPackItem.prototype._trigger_update_holding=function(t){var e=[this.product,t];this.trigger("UpdateHolding",e)},module.exports=SixPackItem;


},{"./_data_model.js":8,"./_eventer.js":9}],28:[function(require,module,exports){
var ProductItem=require("./phd.cart.sixpack.item.js"),ProductHolder=require("./phd.cart.sixpack.holder.js"),SixPackBuilder=function(){this.holding_ele_selector='[data-phd-six-pack="holding"]',this.item_ele_selector='[data-phd-six-pack="item"]',this._init_holder(),this._init_items()};SixPackBuilder.prototype._init_holder=function(){var o=$(this.holding_ele_selector);this.product_holder=new ProductHolder(o)},SixPackBuilder.prototype._init_items=function(){var o=this,i=$(this.item_ele_selector);i.each(function(i,e){var t=$(e),d=new ProductItem(t,i);d.on("AddToHolding",function(i){var e=o.product_holder.add_to_holding(i);d.holding_count=e}),d.on("RemoveFromHolding",function(i){var e=o.product_holder.remove_from_holding(i);d.holding_count=e>0?e:""}),d.on("UpdateHolding",function(i,e){var t=o.product_holder.update_item_in_holding(i,e);d.holding_count=t>0?t:""})})},module.exports=SixPackBuilder;


},{"./phd.cart.sixpack.holder.js":24,"./phd.cart.sixpack.item.js":27}],29:[function(require,module,exports){
