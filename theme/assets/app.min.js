...
var Eventer=require("./_eventer.js"),SixPackHolderItems=function(t){new Eventer(this),this.products=[],this.products_are_addable=!1,this.limit_multiple=t};SixPackHolderItems.prototype.add_item=function(t){this.products.push(t),this._update_is_addable_and_trigger("ItemAdded",[t.id,"added"])},SixPackHolderItems.prototype.remove_item=function(t){for(var e=this.total_count(),r=e-1;r>-1;r--){var o=this._remove_product_from_stack(t,r);if(o)break}this._update_is_addable_and_trigger("ItemRemoved",[t,"removed"])},SixPackHolderItems.prototype.update_item=function(t,e){for(var r=this.item_count(t.id),o=this.total_count(),i=o-1;i>-1;i--)this._remove_product_from_stack(t.id,i);if(e>0)for(var d=0;e>d;d++)this.products.push(t);var s=r>e?"removed":"added";this._update_is_addable_and_trigger("ItemUpdated",[t.id,s])},SixPackHolderItems.prototype.item_count=function(t){for(var e=0,r=0;r<this.products.length;r++)this.products[r].id===t&&e++;return e},SixPackHolderItems.prototype.total_count=function(){return this.products.length},SixPackHolderItems.prototype.total_price=function(){for(var t=0,e=0;e<this.products.length;e++){var r=this.products[e];t+=r.price}return Shopify.formatMoney(t,Bsify.money_formats.moneyFormat)},SixPackHolderItems.prototype.product_by_index=function(t){return this.products[t]},SixPackHolderItems.prototype._remove_product_from_stack=function(t,e){var r=[];return this.products[e].id===t&&(r=this.products.splice(e,1)),r.length>0},SixPackHolderItems.prototype._update_is_addable_and_trigger=function(t,e){this.products_are_addable=this._is_addable(),this.trigger(t,e),this.trigger("ItemsUpdated",e)},SixPackHolderItems.prototype._is_addable=function(){var t=this.total_count(),e=t%this.limit_multiple;return t>0&&0===e},module.exports=SixPackHolderItems;
