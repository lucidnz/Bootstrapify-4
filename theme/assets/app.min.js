...
var Modal={},modal_selector="[data-bsify-modal]",modal_trigger_selector="[data-modal-trigger]",$modal=$(modal_selector),$modal_trigger=$(modal_trigger_selector);Modal.init=function(){$modal.length>0&&$modal_trigger.each(function(e,t){Modal._set_trigger_listener(t)}),Modal._set_event_listeners()},Modal._set_event_listeners=function(){$modal.on("hidden.bs.modal",function(e){$modal.find(".modal-content").html("")})},Modal._set_trigger_listener=function(e){var t=$(e);t.on("click",function(e){e.preventDefault();var t=$(e.currentTarget),o=t.attr("href");$modal.modal(),$.ajax(o).done(function(e){$modal.find(".modal-content").html(e)})})},module.exports=Modal;
