...
var Eventer=require("./_eventer.js"),ItemsTotal=require("./phd.cart.sixpack.holder_total.js"),ItemsHolder=require("./phd.cart.sixpack.holder_items.js"),ItemsDisplay=require("./phd.cart.sixpack.holder_display.js"),ItemSubmitter=require("./phd.cart.sixpack.holder_submitter.js"),SixPackHolder=function(e){this.$ele=e,new Eventer(this);var t=this.$ele.data("phd-holding-limit-multiple")||6,i=this.$ele.data("phd-subscription-id"),s=this.$ele.data("phd-shipping-interval-frequency"),r=this.$ele.data("phd-shipping-interval-unit-type"),d=this.$ele.find("[data-phd-holding-items]"),o=this.$ele.find("form");this.items=new ItemsHolder(t,i,s,r),this.items_display=new ItemsDisplay(d,t,this.items),this.total_display=new ItemsTotal(this.items),this.submitter=new ItemSubmitter(o,this.items),this._add_event_listeners()};SixPackHolder.prototype.add_to_holding=function(e){return this.items.add_item(e),this.items.item_count(e.id)},SixPackHolder.prototype.remove_from_holding=function(e){return this.items.remove_item(e),this.items.item_count(e)},SixPackHolder.prototype.update_item_in_holding=function(e,t){return this.items.update_item(e,t),this.items.item_count(e.id)},SixPackHolder.prototype._add_event_listeners=function(){var e=this;e.items_display.on("RemoveDisplayItem",function(t){e.items.remove_item(t);var i=[t,this.items.item_count(t)];e.trigger("RemoveItem",i)}),e.submitter.on("AddToCart",function(t){e.trigger("AddToCart",[t])}),e.items.on("ItemsCleared",function(){e.trigger("ItemsCleared")})},module.exports=SixPackHolder;
...
var ProductItem=require("./phd.cart.sixpack.item.js"),ProductHolder=require("./phd.cart.sixpack.holder.js"),SixPackBuilder=function(o){this.cart=o,this.holding_ele_selector='[data-phd-six-pack="holding"]',this.item_ele_selector='[data-phd-six-pack="item"]',this.items={},this._init_holder(),this._init_items()};SixPackBuilder.prototype._init_holder=function(){var o=this,t=$(this.holding_ele_selector);o.product_holder=new ProductHolder(t),o.product_holder.on("AddToCart",function(t){console.log("ADD TO CART",t),o.product_holder.items.clear()}),o.product_holder.on("RemoveItem",function(t,e){o.items[t].holding_count=e}),o.product_holder.on("ItemsCleared",function(){for(var t in o.items){var e=o.items[t];e.count=""}})},SixPackBuilder.prototype._init_items=function(){var o=this,t=$(this.item_ele_selector);t.each(function(t,e){var i=$(e),r=new ProductItem(i,t);o.items[r.variant_id]=r,r.on("AddToHolding",function(t){var e=o.product_holder.add_to_holding(t);r.count=e}),r.on("RemoveFromHolding",function(t){var e=o.product_holder.remove_from_holding(t);r.count=e>0?e:""}),r.on("UpdateHolding",function(t,e){var i=o.product_holder.update_item_in_holding(t,e);r.count=i>0?i:""})})},module.exports=SixPackBuilder;


},{"./phd.cart.sixpack.holder.js":25,"./phd.cart.sixpack.item.js":30}],32:[function(require,module,exports){
var CartDisplay=require("./phd.cart.standard_display.js"),CartOffCanvas=require("./phd.cart.standard_offcanvas.js"),StandardCart=function(){var a='a[href="/cart"]';this.off_canvas=new CartOffCanvas(a),this.display=new CartDisplay};StandardCart.prototype.add_products=function(a){console.log("StandardCart:add_products",a)},module.exports=StandardCart;


},{"./phd.cart.standard_display.js":33,"./phd.cart.standard_offcanvas.js":34}],33:[function(require,module,exports){
var DataModel=require("./_data_model.js"),StandardCartDisplay=function(){this._add_event_listenters()};StandardCartDisplay.prototype._add_event_listenters=function(){},module.exports=StandardCartDisplay;


},{"./_data_model.js":9}],34:[function(require,module,exports){
