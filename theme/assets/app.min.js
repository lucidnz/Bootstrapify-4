...
},{"./../../bower_components/shopify-cartjs/dist/cart.js":2,"./bsify.js":12,"./bsify.lookbook_gallery.js":14,"./phd.js":26}],2:[function(require,module,exports){
...
var Eventer=require("./_eventer.js"),PhdAddTo=function(e){this.ele=e,this.$ele=$(e),new Eventer(this),this._add_event_listeners()};PhdAddTo.prototype._add_event_listeners=function(){var e=this;"a"===e._ele_tag_name()?e.$ele.on("click",function(t){t.preventDefault(),e._trigger_add_to(),e.$ele.blur()}):e.$ele.closest("form").on("submit",function(t){t.preventDefault(),e._trigger_add_to()})},PhdAddTo.prototype._trigger_add_to=function(){var e=[this.$ele.data("phd-add-to"),{id:this.$ele.data("phd-variant-id"),title:this.$ele.attr("title")}];this.trigger("addTo",e)},PhdAddTo.prototype._ele_tag_name=function(){return this.ele.tagName.toLowerCase()},module.exports=PhdAddTo;


},{"./_eventer.js":8}],22:[function(require,module,exports){
...
},{"./phd.cart.holding.display.js":22}],24:[function(require,module,exports){
var AddTo=require("./phd.cart.add_to.js"),HoldingCart=require("./phd.cart.holding.js"),ShoppingCart=require("./phd.cart.shopping.js"),PhdCart=function(){this.cart_action_ele=$("[data-phd-add-to]"),this.holding_cart=new HoldingCart,this.shopping_cart=new ShoppingCart,this._init_cart_actions()};PhdCart.prototype._init_cart_actions=function(){var t=this;t.cart_action_ele.each(function(){var a=new AddTo(this);a.on("addTo",function(a,i){switch(a){case"holding":t.holding_cart.add_product(i);break;case"cart":t.shopping_cart.add_product(i)}})})},module.exports=PhdCart;


},{"./phd.cart.add_to.js":21,"./phd.cart.holding.js":23,"./phd.cart.shopping.js":25}],25:[function(require,module,exports){
...
},{"./phd.cart.js":24,"./phd.sticky.js":27}],27:[function(require,module,exports){
