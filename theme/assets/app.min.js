...
var Modal={},modal_selector="[data-bsify-modal]",modal_trigger_selector="[data-modal-trigger]",$modal=$(modal_selector),$modal_trigger=$(modal_trigger_selector);Modal.init=function(){console.log("Modal"),$modal.length>0&&$modal_trigger.each(function(o,l){})},module.exports=Modal;
