...
var SixPackHolderItemsDisplay=function(t,i,e){this.$ele=t,this.items=e,this.limit_multiple=i,this.tooltip_selector='[data-toggle="tooltip"]',this.default_color="#E0F0D9",this._add_event_listeners(),this._build_empty_display_items(),this._add_tooltips()};SixPackHolderItemsDisplay.prototype.update=function(){this._clear_display_items(),this._redraw_display_items(),this._update_display_items(),this._add_tooltips()},SixPackHolderItemsDisplay.prototype.reset=function(){this._clear_display_items(),this._build_empty_display_items(),this._add_tooltips()},SixPackHolderItemsDisplay.prototype._add_event_listeners=function(){var t=this;t.items.on("ItemsUpdated",function(){t.update()})},SixPackHolderItemsDisplay.prototype._redraw_display_items=function(){for(var t=this.items.total_count(),i=Math.floor(t/this.limit_multiple)+1,e=0;i>e;e++)e>0&&this.$ele.append(this._display_item_spacer_markup()),this._build_empty_display_items()},SixPackHolderItemsDisplay.prototype._clear_display_items=function(){this._remove_tooltips(),this.$ele.html("")},SixPackHolderItemsDisplay.prototype._build_empty_display_items=function(){for(var t=0;t<this.limit_multiple;t++)this.$ele.append(this._empty_display_item_markup())},SixPackHolderItemsDisplay.prototype._empty_display_item_markup=function(){return'<div class="holding-item holding-item-disabled" data-toggle="tooltip" data-placement="bottom" title="Empty item slot"></div>'},SixPackHolderItemsDisplay.prototype._display_item_spacer_markup=function(){return'<div class="holding-item-spacer"></div>'},SixPackHolderItemsDisplay.prototype._update_display_items=function(){for(var t=this.items.total_count(),i=0;t>i;i++){var e=this.items.product_by_index(i),s=e.color||this.default_color;-1===s.indexOf("#")&&(s="#"+s),this.$ele.find(".holding-item").eq(i).removeClass("holding-item-disabled").attr("title",e.title).css("background-color",s)}},SixPackHolderItemsDisplay.prototype._add_tooltips=function(){$(this.tooltip_selector).tooltip()},SixPackHolderItemsDisplay.prototype._remove_tooltips=function(){$(this.tooltip_selector).tooltip("destroy")},module.exports=SixPackHolderItemsDisplay;
...
var Eventer=require("./_eventer.js"),DataModel=require("./_data_model.js"),PhdModal=function(e){this.selector=e||"[data-bsify-modal]",this.$ele=$(this.selector),new Eventer(this),new DataModel(this,{content:this.selector+" .modal-content"}),this.$ele.modal({show:!1}),this._add_event_listeners()};PhdModal.prototype.open=function(){this.$ele.modal("show"),this.trigger("ModalOpened")},PhdModal.prototype.close=function(){this.$ele.modal("hide"),this.trigger("ModalClosed"),this.destroy()},PhdModal.prototype.destroy=function(){this.content=""},PhdModal.prototype._add_event_listeners=function(){var e=this;this.$ele.on("hidden.bs.modal",function(t){console.log("modal closed",t),e.trigger("ModalClosed"),e.destroy()})},module.exports=PhdModal;


},{"./_data_model.js":8,"./_eventer.js":9}],33:[function(require,module,exports){
