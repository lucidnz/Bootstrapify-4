...
},{"./../../bower_components/shopify-cartjs/dist/cart.js":2,"./bsify.js":12,"./bsify.lookbook_gallery.js":14,"./phd.js":27}],2:[function(require,module,exports){
...
},{"./../../bower_components/shopify-cartjs/dist/cart.js":2}],11:[function(require,module,exports){
...
},{"./bsify.banner.js":9,"./bsify.cart.js":10,"./bsify.image_switcher.js":11,"./bsify.linked_product_options.js":13,"./bsify.social_feeds.js":17,"./bsify.thumbnails.js":18,"./bsify.variant_option_switcher.js":20}],13:[function(require,module,exports){
...
},{"./bsify.media_queries.js":15,"./bsify.touch.js":19,"imagesloaded":3}],15:[function(require,module,exports){
...
},{"./bsify.social_feed_instagram.js":16}],18:[function(require,module,exports){
...
},{"jquery-orderly":6,"uniformThumbnails":7}],19:[function(require,module,exports){
...
var AddTo=require("./phd.cart.add_to.js"),HoldingCart=require("./phd.cart.holding.js"),PhdAddToHolding=function(){this.holding_cart=new HoldingCart;var d=this;$('[data-phd-add-to="holding"]').each(function(){var t=new AddTo(this);t.args=function(){return[{id:t.$ele.data("phd-variant-id"),title:t.$ele.attr("title")}]},t.on("addTo",function(t){d.holding_cart.add_product(t)})})};module.exports=PhdAddToHolding;


},{"./phd.cart.add_to.js":22,"./phd.cart.holding.js":24}],22:[function(require,module,exports){
var Eventer=require("./_eventer.js"),PhdAddTo=function(e){this.ele=e,this.$ele=$(e),new Eventer(this),this._add_event_listeners()};PhdAddTo.prototype.args=function(){return[]},PhdAddTo.prototype._add_event_listeners=function(){var e=this;"a"===e._ele_tag_name()?e.$ele.on("click",function(t){t.preventDefault(),e._trigger_add_to(),e.$ele.blur()}):e.$ele.closest("form").on("submit",function(t){t.preventDefault(),e._trigger_add_to()})},PhdAddTo.prototype._trigger_add_to=function(){var e=this.args();this.trigger("addTo",e)},PhdAddTo.prototype._ele_tag_name=function(){return this.ele.tagName.toLowerCase()},module.exports=PhdAddTo;


},{"./_eventer.js":8}],23:[function(require,module,exports){
var PhdCartHoldingDisplay=function(t){this.$ele=t,this.$items_wrapper=this.$ele.find("[data-phd-holding-items]"),this.submit_to_cart_button=this.$ele.find('[type="submit"]'),this._build_properties(),this._build_empty_display_items()};PhdCartHoldingDisplay.prototype.add_item=function(t,i){this.$items_wrapper.html("");for(var e=Math.floor(t.length/this.limit_multiple)+1,l=0;e>l;l++)this._build_empty_display_items(e);for(var d=[],a=0;a<t.length;a++){var p=t[a].id,s=t[a].title;this.$items_wrapper.find(".holding-item").eq(a).removeClass("holding-item-disabled").html(s),d.push(p)}this.submit_to_cart_button.data("phd-variant-id",d).attr("data-phd-variant-id",d),i?this.submit_to_cart_button.prop("disabled",!1):this.submit_to_cart_button.prop("disabled",!0)},PhdCartHoldingDisplay.prototype._build_properties=function(){Object.defineProperty(this,"limit_multiple",{enumerable:!0,configurable:!0,get:function(){return this.$ele.data("phd-holding-limit-multiple")},set:function(t){this.$ele.data("phd-holding-limit-multiple")!==t&&this.$ele.data("phd-holding-limit-multiple",t).attr("data-phd-holding-limit-multiple",t)}})},PhdCartHoldingDisplay.prototype._build_empty_display_items=function(){for(var t=0;t<this.limit_multiple;t++)this.$items_wrapper.append(this._empty_display_item_markup())},PhdCartHoldingDisplay.prototype._empty_display_item_markup=function(){return'<div class="holding-item holding-item-disabled"><span class="text-muted">item</span></div>'},module.exports=PhdCartHoldingDisplay;


},{}],24:[function(require,module,exports){
var HoldingDisplay=require("./phd.cart.holding.display.js"),PhdCartHolding=function(){var i="[data-phd-holding]",t=$(i);return t.length>0?(this.display=new HoldingDisplay(t),this.limit_multiple=this.display.limit_multiple||6,this.items=[],this.items_are_addable=!1,void 0):!1};PhdCartHolding.prototype.add_product=function(i){this.items.push(i),this._update_addable(),this.display.add_item(this.items,this.items_are_addable)},PhdCartHolding.prototype._update_addable=function(){this._is_addable()?this.items_are_addable=!0:this.items_are_addable=!1},PhdCartHolding.prototype._is_addable=function(){var i=this.items.length%this.limit_multiple;return this.items.length>0&&0===i},module.exports=PhdCartHolding;


},{"./phd.cart.holding.display.js":23}],25:[function(require,module,exports){
var HoldingCart=require("./phd.cart.add_to.holding.js"),ShoppingCart=require("./phd.cart.shopping.js"),PhdCart=function(){new HoldingCart,this.shopping_cart=new ShoppingCart};module.exports=PhdCart;


},{"./phd.cart.add_to.holding.js":21,"./phd.cart.shopping.js":26}],26:[function(require,module,exports){
var PhdCartShopping=function(){};PhdCartShopping.prototype.add_product=function(o){console.log("add to shopping cart",o)},module.exports=PhdCartShopping;
...
},{"./phd.cart.js":25,"./phd.sticky.js":28}],28:[function(require,module,exports){
