...
var Eventer=require("./_eventer.js"),SixPackHolderItems=function(t,i,e,r,o){new Eventer(this),this.products=[],this.products_are_addable=!1,this.limit_multiple=t,this.builder_group_title=i,this.subscription_id=e,this.shipping_interval_frequency=r,this.shipping_interval_unit_type=o};SixPackHolderItems.prototype.add_item=function(t){this.products.push(t),this._update_is_addable_and_trigger("ItemAdded",[t.id,"added"])},SixPackHolderItems.prototype.remove_item=function(t){for(var i=this.total_count(),e=i-1;e>-1;e--){var r=this._remove_product_from_stack(t,e);if(r)break}this._update_is_addable_and_trigger("ItemRemoved",[t,"removed"])},SixPackHolderItems.prototype.update_item=function(t,i){for(var e=this.item_count(t.id),r=this.total_count(),o=r-1;o>-1;o--)this._remove_product_from_stack(t.id,o);if(i>0)for(var d=0;i>d;d++)this.products.push(t);var s=e>i?"removed":"added";this._update_is_addable_and_trigger("ItemUpdated",[t.id,s])},SixPackHolderItems.prototype.clear=function(){var t=this.all_products_by_id();for(var i in t)if(t.hasOwnProperty(i)){var e=t[i];this.update_item(e,0)}this.trigger("ItemsCleared")},SixPackHolderItems.prototype.item_count=function(t){for(var i=0,e=0;e<this.products.length;e++)this.products[e].id===t&&i++;return i},SixPackHolderItems.prototype.total_count=function(){return this.products.length},SixPackHolderItems.prototype.total_price=function(){for(var t=0,i=0;i<this.products.length;i++){var e=this.products[i];t+=e.price}return Shopify.formatMoney(t,Bsify.money_formats.moneyFormat)},SixPackHolderItems.prototype.product_by_index=function(t){return this.products[t]},SixPackHolderItems.prototype.all_products_by_id=function(t){for(var i={},e=0;e<this.products.length;e++){var r=this.products[e];i[r.id]?(i[r.id].quantity++,i[r.id].line_price=i[r.id].price*i[r.id].quantity):(i[r.id]={id:r.id,title:r.title,price:r.price,line_price:r.price,quantity:1,properties:{group_title:this.builder_group_title,builder_group:(new Date).getTime()}},t&&(i[r.id].properties.shipping_interval_frequency=this.shipping_interval_frequency,i[r.id].properties.shipping_interval_unit_type=this.shipping_interval_unit_type,i[r.id].properties.subscription_id=this.subscription_id))}return i},SixPackHolderItems.prototype._remove_product_from_stack=function(t,i){var e=[];return this.products[i].id===t&&(e=this.products.splice(i,1)),e.length>0},SixPackHolderItems.prototype._update_is_addable_and_trigger=function(t,i){this.products_are_addable=this._is_addable(),this.trigger(t,i),this.trigger("ItemsUpdated",i)},SixPackHolderItems.prototype._is_addable=function(){var t=this.total_count(),i=t%this.limit_multiple;return t>0&&0===i},module.exports=SixPackHolderItems;
...
var CartJS=require("./../../bower_components/shopify-cartjs/dist/cart.js"),CartDisplay=require("./phd.cart.standard_display.js"),CartOffCanvas=require("./phd.cart.standard_offcanvas.js"),StandardCart=function(){var t='a[href="/cart"]';this.off_canvas=new CartOffCanvas(t),this.display=new CartDisplay,this._add_event_listeners()};StandardCart.prototype.add_products=function(t){this.display.update_cart_items(t);for(var a in t)if(t.hasOwnProperty(a)){var r=t[a];this.add_product(r)}},StandardCart.prototype.add_product=function(t){var a=this;CartJS.addItem(t.id,t.quantity,t.properties,{success:function(t,r,d){a._item_added_success(t,r,d)},error:function(t,r,d){a._item_added_error(t,r,d)}})},StandardCart.prototype._add_event_listeners=function(){var t=this;$(document).on("cart.requestComplete",function(a,r){t.display.update_cart_items(r.items)})},StandardCart.prototype._item_added_success=function(t,a,r){},StandardCart.prototype._item_added_error=function(t,a,r){console.log("Item added: error",t,a,r)},module.exports=StandardCart,window.CartJS=CartJS;
...
var DataModel=require("./_data_model.js"),CartItems=require("./phd.cart.standard_display_items.js"),StandardCartDisplay=function(){this.$details=$(".side-cart-details"),this.$empty_message=$(".side-cart-empty"),this.section_empty_message_selector=".side-cart-section-empty";var t=".phd-side-cart-item-template",a="[data-phd-side-cart-item]",e="[data-phd-side-cart-items-subscription]",s="[data-phd-side-cart-items-one-off]";this.subscription_items=new CartItems(e,a,t),this.one_off_items=new CartItems(s,a,t),this.item_groups=[this.subscription_items,this.one_off_items]};StandardCartDisplay.prototype.update_cart_items=function(t){this.clear(),void 0===t.length?this._add_cart_items_as_object(t):this._add_cart_items_as_array(t),this.post_update()},StandardCartDisplay.prototype.update_cart_item=function(t){void 0!==t.properties.subscription_id?this.subscription_items.update_cart_item(t):this.one_off_items.update_cart_item(t)},StandardCartDisplay.prototype.clear=function(){this._each(function(t,a){a.clear_items()})},StandardCartDisplay.prototype.post_update=function(){this._update_cart_empty_state()},StandardCartDisplay.prototype._add_cart_items_as_object=function(t){var a=[];for(var e in t)if(t.hasOwnProperty(e)){var s=t[e];a.push(s)}this._add_cart_items_as_array(a)},StandardCartDisplay.prototype._add_cart_items_as_array=function(t){t.sort(function(t,a){return t.title>a.title?1:t.title<a.title?-1:0});for(var a=0;a<t.length;a++){var e=t[a];this.update_cart_item(e)}},StandardCartDisplay.prototype._update_cart_empty_state=function(){var t=0;this._each(function(a,e){var s=e.count();s>0?(e.$items_wrapper.next(this.section_empty_message_selector).hide(),t+=s):e.$items_wrapper.next(this.section_empty_message_selector).show()}),t>0?(this.$empty_message.hide(),this.$details.show()):(this.$empty_message.show(),this.$details.hide())},StandardCartDisplay.prototype._each=function(t){for(var a=0;a<this.item_groups.length;a++){var e=this.item_groups[a];t(a,e)}},module.exports=StandardCartDisplay;
...
//# sourceMappingURL=data:application/json;base64,
