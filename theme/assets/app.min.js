...
},{"./bsify.banner.js":8,"./bsify.cart.js":9,"./bsify.image_switcher.js":10,"./bsify.linked_product_options.js":12,"./bsify.password_recover.js":15,"./bsify.social_feeds.js":17,"./bsify.thumbnails.js":18,"./bsify.variant_option_switcher.js":20}],12:[function(require,module,exports){
...
},{"./bsify.media_queries.js":14,"./bsify.touch.js":19,"imagesloaded":3}],14:[function(require,module,exports){
...
var PasswordRecover=function(){this.recover_string="#recover",this.$links=$('[href*="/account/login"]'),this.$sections=$("[data-bsify-toggle-recover]"),this._add_event_listeners(),this.toggle_forms()};PasswordRecover.prototype.toggle_forms=function(){window.location.hash===this.recover_string?this.show_recover_form():this.show_login_form()},PasswordRecover.prototype.show_recover_form=function(){var o=this;this._each_section(function(e){o._toggle_section("recover"===e.data("bsify-toggle-recover"),e)})},PasswordRecover.prototype.show_login_form=function(){var o=this;this._each_section(function(e){o._toggle_section("recover"!==e.data("bsify-toggle-recover"),e)})},PasswordRecover.prototype._add_event_listeners=function(){var o=this;o.$links.on("click",function(e){e.preventDefault(),o._on_click($(e.currentTarget))})},PasswordRecover.prototype._on_click=function(o){o.attr("href").indexOf(_this.recover_string)>-1?_this.show_recover_form():_this.show_login_form()},PasswordRecover.prototype._each_section=function(o){this.$sections.each(function(e,t){var r=$(t);o(r)})},PasswordRecover.prototype._toggle_section=function(o,e){o?e.show():e.hide()},module.exports=PasswordRecover;
